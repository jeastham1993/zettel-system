resource "aws_s3_bucket" "frontend" {
  bucket = "${var.app_name}-frontend-${var.suffix}"
}
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  default_cache_behavior {
    ...
    # 1-hour cache for static assets; Vite generates hashed filenames
    min_ttl     = 0
    default_ttl = 3600
    max_ttl     = 86400
  }

  # React Router requires all unmatched paths to return index.html (SPA pattern)
