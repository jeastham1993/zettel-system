...
public static class ZettelTelemetry
{
    ...
    // Chat metrics
    public static readonly Counter<long> ChatMessagesGenerated = Meter.CreateCounter<long>(
        "zettel.chat.messages_generated", description: "Number of chat messages generated by the assistant");
    public static readonly Histogram<double> ChatResponseDuration = Meter.CreateHistogram<double>(
        "zettel.chat.response_duration", "ms", "Time taken to generate a chat response");
}
